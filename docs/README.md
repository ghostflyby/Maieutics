...
- [ADR 0003: Deno Jupyter REPL and notebook output bridge](architecture/decisions/0003-deno-jupyter-repl-output-bridge.md)
...
- [ADR 0006: Selective Microsoft Agent Framework adoption](architecture/decisions/0006-selective-microsoft-agent-framework-adoption.md)
