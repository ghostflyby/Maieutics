...
internal sealed class DenoReplModule
{
    ...
    [
        ...
        ("Maieutics.Deno.Widgets.Index.ts", "maieutics-widgets/index.ts"),
        ("Maieutics.Deno.Widgets.Runtime.ts", "maieutics-widgets/runtime.ts"),
        ("Maieutics.Deno.Widgets.Controls.ts", "maieutics-widgets/controls.ts"),
        ("Maieutics.Deno.Widgets.VNode.ts", "maieutics-widgets/vnode.ts"),
        ("Maieutics.Deno.Widgets.Transform.ts", "maieutics-widgets/transform.ts"),
        ("Maieutics.Deno.Widgets.Style.ts", "maieutics-widgets/style.ts"),
        ("Maieutics.Deno.Widgets.JsxRuntime.ts", "maieutics-widgets/jsx-runtime.ts"),
        ("Maieutics.Deno.Widgets.Config.json", "maieutics-widgets/deno.json"),
