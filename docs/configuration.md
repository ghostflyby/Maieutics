...
bounded unified diff as structured tool output and enforce the same safety envelope as the read tools. They operate on
one fixed workspace home (ADR 0027) selected when the process begins:
